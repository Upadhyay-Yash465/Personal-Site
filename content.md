...
#
# Format:
#   ### key            → a text field (one block of copy)
#   ### key []         → a list; each item starts with "- " and has
#                        "field: value" lines under it
# Inline markdown allowed in text: **bold**, *italic*, `code`, [link](url).
# Lines starting with # are comments. The brand name "Yash Upadhyay",
# nav labels, and page <title>s stay in the HTML.
# ──────────────────────────────────────────────────────────────
...
### home.contact []
- label: Email
  href: mailto:yupadhyay2007@gmail.com
- label: GitHub
  href: https://github.com/eyash24
- label: LinkedIn
  href: https://www.linkedin.com/in/yashupadhyay12
